<?php
/**
 * Class presents the Main page for Github browser site - GitAsterisk
 * @author Igor Khromov
 * @date 10 July 2013
*/
...
class Main extends CI_Controller{
    ...
    public function index(){
        ...
        $project_details = $this->_git_manager->getProjectDetails(DEFAULT_GITHUB_PROJECT, DEFAULT_GITHUB_OWNER);
